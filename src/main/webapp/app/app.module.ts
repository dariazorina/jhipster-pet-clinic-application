...
@NgModule({
    imports: [
        ...
        JhPetClinicSharedModule.forRoot(),
        JhPetClinicCoreModule,
        JhPetClinicHomeModule,
        JhPetClinicAccountModule,
