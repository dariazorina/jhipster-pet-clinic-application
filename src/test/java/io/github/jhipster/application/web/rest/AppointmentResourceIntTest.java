...
public class AppointmentResourceIntTest {
    ...
    private static final Integer DEFAULT_PET_ID = 1;
    private static final Integer UPDATED_PET_ID = 2;
    ...
    public void createAppointment() throws Exception {
        ...
        assertThat(testAppointment.getPetId()).isEqualTo(DEFAULT_PET_ID);
        assertThat(testAppointment.getComment()).isEqualTo(DEFAULT_COMMENT);
    ...
    public void getAllAppointments() throws Exception {
        ...
        restAppointmentMockMvc.perform(get("/api/appointments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].petId").value(hasItem(DEFAULT_PET_ID)))
    ...
    public void getAppointment() throws Exception {
        ...
        restAppointmentMockMvc.perform(get("/api/appointments/{id}", appointment.getId()))
            ...
            .andExpect(jsonPath("$.petId").value(DEFAULT_PET_ID))
    ...
    public void updateAppointment() throws Exception {
        ...
        assertThat(testAppointment.getPetId()).isEqualTo(UPDATED_PET_ID);
        assertThat(testAppointment.getComment()).isEqualTo(UPDATED_COMMENT);
